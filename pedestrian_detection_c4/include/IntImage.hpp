//
// Created by 翁规范 on 9/30/17.
//

#ifndef PEDESTRIAN_DETECTION_C4_INTIMAGE_HPP
#define PEDESTRIAN_DETECTION_C4_INTIMAGE_HPP
...
private:
    IntImage(const IntImage<T> &source) {
...
#endif //PEDESTRIAN_DETECTION_C4_INTIMAGE_HPP
